...
export default function Login() {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="bg-signal relative flex flex-col p-10 text-primary-foreground">
      ...
      <div className="hermes-surface flex items-center justify-center p-8">
