...
export default function About() {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl">
      ...
      <section className="hermes-card flex items-start gap-5 p-6">
        <HermesMark className="mt-1 h-12 w-12 shrink-0 text-secondary" />
        <div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {L.stack.map((c, i) => (
          <div key={c.name} className="hermes-card p-6">
      ...
      <section className="hermes-card mt-8 p-6">
