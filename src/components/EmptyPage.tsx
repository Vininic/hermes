 ...
 *  Each domain page (Dashboard, Outbox, Flows…) swaps this out for real
 *  content in its own milestone; see HERMES.md. Copied verbatim from Pluto's
 *  `EmptyPage.tsx` (same convention across the suite). */
